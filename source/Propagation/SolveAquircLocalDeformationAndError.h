                            ...
                            for (;!it.IsAtEnd();++it){
                                ...
                                for (unsigned int d=0;d<D;++d){
                                    ...
                                    if (m_wWcirc>0.0){
                                        ...
                                        for (int i=0;i<ptIntermediateNeighbors.size();++i){
                                            x[c]=eq;
                                            y[c]=edgeNumDeformation(source,intermediate,ptIntermediateNeighbors[i].first,d); // this is a APPROXIMIATION!!! might be bad :o
