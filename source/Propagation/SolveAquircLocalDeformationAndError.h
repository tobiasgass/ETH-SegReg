                            ...
                            for (;!it.IsAtEnd();++it){
                                ...
                                for (unsigned int d=0;d<D;++d){
                                   ...
                                   //b[eq-1]=delta3[d];
                                    ...
                                    //set eqn for soft constraining the true deformation to be similar to the original deformation
                                    x[c]=eq;
                                    y[c]=e3+d+m_nPixels;
                                    v[c++]=0.5*val;
                                    b[eq-1]=0.5*delta3[d];
        ...
        for (int s = 0;s<m_numImages;++s){
            for (int t=0;t<m_numImages;++t){
                if (s!=t){
                    ...
                    DeformationFieldPointerType estimatedDeform=ImageUtils<DeformationFieldType>::createEmpty((*m_deformationCache)[(*m_imageIDList)[s]][(*m_imageIDList)[t]]);
