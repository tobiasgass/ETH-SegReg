...
namespace SRS{
  ...
  protected:
    ...
    PointType m_previousPoint1,m_previousPoint2;
    DisplacementType m_prevDisp1, m_prevDisp2;
  ...
  public:
	...
	if ( pt1!=m_previousPoint1){
	  ...
	  m_previousPoint1=pt1;
	}
	if (pt2!=m_previousPoint2){
	  IndexType targetIndex2;
	  m_baseDisplacementMap->TransformPhysicalPointToIndex(pt2, targetIndex2);
	  m_prevDisp2= m_baseDisplacementMap->GetPixel((targetIndex2));
	  m_previousPoint2=pt2;
	}


	displacement1 += m_prevDisp1;
	displacement2 += m_prevDisp2;
      }
#if 1
