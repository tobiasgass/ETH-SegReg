...
public:
	...
	virtual void createGraph(){
		...
		if (secondPairwise){
			optimizer= new CV_Fast_PD3(this->m_nNodes,this->m_nLabels,unaryPotentials,this->m_nPairs,&pairs[0],pairwisePotentials, pairwisePotentials2,20,&edgeWeights[0],int(this->m_nLabels/4));
		}else{
			optimizer= new CV_Fast_PD3(this->m_nNodes,this->m_nLabels,unaryPotentials,this->m_nPairs,&pairs[0],pairwisePotentials, pairwisePotentials,20,&edgeWeights[0],int(this->m_nLabels/4));
		}
