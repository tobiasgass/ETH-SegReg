...
#ifndef SRSIMAGETOIMAGEFILTER_H_
#define SRSIMAGETOIMAGEFILTER_H_
#include "SRSConfig.h"
...
private:
	SRSConfig m_config;
public:
	SRSImageToImageFilter(SRSConfig c){
		m_config=c;
	}
	bool run(){
		...
		//	typedef typename  ITKGraphModel<UnaryPotentialType,LabelMapperType,ImageType> GraphModelType;
