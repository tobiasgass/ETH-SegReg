...
template<class TLabel,class TImage,class TSegmentationInterpolator, class TImageInterpolator>
class SegmentationRegistrationUnaryPotential : public RegistrationUnaryPotential<TLabel,TImage, TImageInterpolator>{
public:
	//itk declarations
	typedef SegmentationRegistrationUnaryPotential            Self;
	typedef RegistrationUnaryPotential<TLabel,TImage,TImageInterpolator>                    Superclass;
	...
	typedef typename Superclass::LabelImagePointerType LabelImagePointerType;
