#ifndef ONLINE_NODE_GINI_
#define ONLINE_NODE_GINI_
...
class OnlineNodeGini : public OnlineNode
{
 public:
    typedef boost::shared_ptr<OnlineNodeGini> Ptr;

    OnlineNodeGini(const HyperParameters &hp, int depth, int numFeatures);
    OnlineNodeGini(const HyperParameters &hp, int depth, int numFeatures, std::vector<int>& labelStatistics);
