...
RandomNaiveBayes::RandomNaiveBayes(const HyperParameters &hp) : m_hp( hp )
{
}

RandomNaiveBayes::~RandomNaiveBayes()
{
}

void RandomNaiveBayes::train(const matrix<float>& data, const std::vector<int>& labels, bool use_gpu)
{
    // Initialize
...
void RandomNaiveBayes::initialize(const int numSamples)
{
...
void RandomNaiveBayes::trainByCPU(const matrix<float>& data, const std::vector<int>& labels)
{
...
void RandomNaiveBayes::eval(const matrix<float>& data, const std::vector<int>& labels)
{
    ...
    BOOST_FOREACH(NaiveBayes::Ptr nbc, m_naiveBayesClassifiers)
    {
...
double RandomNaiveBayes::computeError(const std::vector<int>& labels)
{
    int error = 0;
